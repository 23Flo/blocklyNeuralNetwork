...
const CopyWebpackPlugin = require('copy-webpack-plugin'); // Neu hinzugefügt
...
const config = {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin({ // Neu hinzugefügt
      patterns: [
        { from: 'src/data', to: 'data' }, // Kopiert den data-Ordner nach dist/data
      ],
    }),
  ],
};
